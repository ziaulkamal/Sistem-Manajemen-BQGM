		...
		<div class="col-md-6 grid-margin stretch-card">
			<div class="card">
				<div class="card-body">
					...
					<form class="forms-sample" action="<?= base_url('angsuran/update/process/').$id.'/normal' ?>" method="POST"
							...
							<div class="col-md-4">
								<div class="mb-4">
									<label class="form-label">Bagi Hasil</label>
										<input type="text" class="form-control" value="<?= 'Rp. '. number_format($data->bagiHasil) ?>" readonly>
								</div>
							</div>
							<div class="col-md-2">
								<div class="mb-4">
									<label class="form-label">Pembayaran Ke</label>
										<input type="text" class="form-control" value="<?= ($data->tenor - $data->sisaTenor)+1 ?>" readonly>
								</div>
							</div>
							<div class="col-md-10">
								<div class="mb-4">
									<label class="form-label">Total Setoran</label>
										<input type="text" class="form-control" value="<?= 'Rp. '. number_format(($data->pokokMudharabah/$data->tenor)+($data->pokokRahn/$data->tenor)+$data->bagiHasil) ?>" readonly>
								</div>
							</div>
						</div>
