		...
		<div class="col-lg-12 grid-margin stretch-card">
			<div class="card">
				<div class="card-body">
					...
					<form class="forms-sample" action="<?= base_url('laporan/operasional/masuk/date/_lihat') ?>" method="POST"
    ...
    <script>
        ...
        function ExportToExcel(type, fn, dl) {
            ...
            return dl ?
                ...
                XLSX.writeFile(wb, fn || ('[Laporan] Data-Operasional(MASUK)-<?= date('d-m-Y') ?>.' + (type || 'xlsx')));
        }
		
		function backTo() {
			window.location.href= "<?= base_url('laporan/operasional/masuk/_lihat') ?>"
		}
