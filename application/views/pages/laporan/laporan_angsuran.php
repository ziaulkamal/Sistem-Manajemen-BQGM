...
<div class="page-content">
			...
			<div class="card">
				<div class="card-body">
					<h4 class="card-title"><?= $title ?></h4>
										<form class="forms-sample" action="<?= base_url('laporan/angsuran/date/_lihat') ?>" method="POST"
    ...
    <script>
		...
		function backTo() {
			window.location.href= "<?= base_url('laporan/angsuran/_lihat') ?>"
		}
        function ExportToExcel(type, fn, dl) {
            ...
            return dl ?
                ...
                XLSX.writeFile(wb, fn || ('[Laporan] Data-Angsuran-<?= date('d-m-Y') ?>.' + (type || 'xlsx')));
        }
