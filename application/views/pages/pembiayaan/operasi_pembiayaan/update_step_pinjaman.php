		...
		<div class="col-md-8 grid-margin stretch-card">
			<div class="card">
				<div class="card-body">
					...
					<form class="forms-sample" action="<?= base_url('pembiayaan/data_anggota/update/process/').$data->id_pinjaman.'/'.$action ?>"
						...
						<div class="row">
							<div class="col-md-4">
								<div class="mb-3">
									...
									<input type="text" class="form-control" value="<?= ucwords($data->namaAnggota).' ***'.$data->id_anggota.'***' ?>" readonly>
								</div>
							</div>
							...
							<div class="col-md-4">
								<div class="mb-3">
									...
									<input type="date" class="form-control date" name="prediksi" value="<?php if ($action == 'edit') {
                                        echo $data->tglPrediksi;
                                    }else {
                                         echo set_value('prediksi');
                                    } ?>">
						...
						<div class="row">
							<div class="col-md-4">
								<div class="mb-3">
									...
									<input type="text" class="form-control" name="pl6bulan" value="<?= $data->penghasilan6Bulan ?>">
							...
							<div class="col-md-4">
								<div class="mb-3">
									...
									<input type="text" class="form-control" name="pbrt6bulan" value="<?= $data->pengeluaran6Bulan ?>">
							...
							<div class="col-md-4">
								<div class="mb-3">
									...
									<input type="text" class="form-control" name="al6bulan" value="<?= $data->angsuranLain6Bulan ?>">
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-md-4">
								<div class="mb-3">
									...
									<input type="text" class="form-control" name="bo" value="<?= $data->biayaOperasional ?>">
							...
							<div class="col-md-2">
								<div class="mb-3">
									...
									<input type="text" class="form-control" name="proyeksi" value="<?= $data->proyeksiPanen ?>">
						...
						<div class="row">
							<div class="col-md-6">
								<div class="mb-3">
									...
									<input type="text" class="form-control" name="rahn" value="<?= $data->pokokRahn ?>">
							...
							<div class="col-md-6">
								<div class="mb-3">
									...
									<input type="text" class="form-control" name="mudharabah" value="<?= $data->pokokMudharabah ?>">
